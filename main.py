...
def main():
    ...
    print("Welcome to our project. The following options are available:")
    while ext == False:
        ...
        print(" 8 - Inverting a matrix")
        print(" 9 - Evaluating random spanning vectors")
        print(" 10 - Exit")
        ...
        if selection == 1:
            ...
            print("The reduced row eschelon form of the matrix:")
            ...
            print("Input a matrix")
            matrix = pr.input_matrices()
            inverse = mi.invert(matrix)
            print("The inverse of this matrix:")
            pr.print_matrix(inverse)
        elif selection == 9:
            coordinates = input("Input the number of random coordinates in each matrix: ")
            vectors = input("Input how many vectors in the spanning set: ")
            trials = input("Input the number of trials: ")
            expected_dimension = rs.expected_dimension(trials, vectors, coordinates)
            print("After " + str(trials) + ", the average dimensions of the spanning space is " + str(expected_dimension) +".")
        elif selection == 10:
            ext = True
